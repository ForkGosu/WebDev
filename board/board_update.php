...
<body class="d-flex h-100 text-center text-white bg-dark">
    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        ...
        <!-- main 시작 -->
        <main class="px-3">
          <form action="/proc/board_update_proc.php" id="boardForm" method="POST">
            <blockquote blockquote><h3>수정하기</h3></blockquote>
            <input class="board_idx" name="idx" type="hidden" value="<?=$board_view['idx']?>">
            <!-- 제목 -->
            <input class="board_subject" name="subject" type="text" value="<?=$board_view['subject']?>" placeholder="제목">
            <!-- 내용 -->
            <textarea class="board_content" name="content" placeholder="내용"><?=$board_view['content']?></textarea>
            <!-- 버튼 -->
            <p class="lead">
