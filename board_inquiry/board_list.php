...
<?php 
  ...
  $total_items = GetTotalBoardCount($search_column, $search_word, $date_from, $date_to, "inquiry"); // 총 게시물 수
...
<?php $board_list = BoardListToSearch($page, $items_per_page, $search_column, $search_word, $order_column, $order_sort, $date_from, $date_to, "inquiry"); ?>
        ...
        <main class="px-3">
          ...
          <table class="table table-sm table-hover">
            ...
            <tbody>
              ...
              ?>
                <tr onClick="location.href='board_view_check.php?idx=<?=$row['idx']?>'" style="cursor:pointer;">
                  <td><?= $row['idx'] ?></td>
          ...
          <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <button class="btn btn-primary" type="button" onClick="location.href='board_write.php'">문의하기</button>
          </div>
          </p>
          <!-- 페이징 -->
          <p class="lead">
