    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
        ...
        <main class="px-3">
          <form action="/proc/board_update_proc.php" id="boardForm" method="POST" enctype="multipart/form-data">
            ...
            <input name="idx" type="hidden" value="<?=$board_view['idx']?>">
            <input name="file_idx" type="hidden" value="<?=$board_view['file_idx']?>">
            <input name="board_type" type="hidden" value="<?=$board_view['board_type']?>">
            <!-- 제목 -->
